    ...
    with open(output_path, 'w') as txt_file:
        for sentence in tree.findall(".//sentence"):
            ...
            for opinion in sentence.findall(".//Opinions/Opinion"):
                target_opinion = opinion.get("target") if opinion.get("target") else "NULL"
                temp_list_opinion = [target_opinion, (re.sub(r"#", " ", opinion.get("category"))).lower(), opinion.get("polarity")]
